...
- Remotion UI scenes: shared **`UI_SCENE_BACKDROP_STYLE`** in **`remotion/src/ui-scene-backdrop.ts`** (subtle radial glow on **`#0f0f0e`**) on **`SizzleReel`** + Hook / close-up / detail / zoom / CTA / **MetaNarrative** / **LeaderboardTest**.
