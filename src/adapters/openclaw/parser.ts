 ...
 * Tokscale's OpenClaw adapter (`crates/tokscale-core/src/sessions/openclaw.rs`, commit
...
/**
 * Provenance note:
 * The assistant-only message parsing and model-change tracking were inspired by Tokscale's
 * OpenClaw transcript parser (`crates/tokscale-core/src/sessions/openclaw.rs`, commit
 * d438a7d9514a3af4ff2a4e1ae20ce6b370720e5b). ClawRank keeps the same adapter-only boundary,
 * but translates into daily agent facts instead of Tokscale's unified message model.
 */
