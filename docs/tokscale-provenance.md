# Tokscale provenance for the OpenClaw pilot

This pilot intentionally reuses **Tokscale ideas only in plumbing layers**.
...
- Tokscale repo: `crates/tokscale-core/src/sessions/openclaw.rs`
- Commit inspected during this pilot: `d438a7d9514a3af4ff2a4e1ae20ce6b370720e5b`

How ClawRank differs:
- rewritten in TypeScript
- no Tokscale unified-message model copied over
- output is ClawRank adapter messages, then ClawRank daily agent facts

## Explicit non-reuse

The following are **not** reused from Tokscale and should stay ClawRank-native:
...
If code starts to import Tokscale assumptions above the adapter/plumbing layer, it is outside the approved reuse boundary and should be rejected.
